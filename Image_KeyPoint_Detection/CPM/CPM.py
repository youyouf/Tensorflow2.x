...
class CPM:
    ...
    def train(self):
        ...
        model.fit_generator(
            self.dataGenerator(mode='training'),
            steps_per_epoch=5,
            epochs=self.epochs,
            validation_data=self.dataGenerator(mode='validation'),
            validation_steps=5
        )
        ...
        if mode == 'training':
            ...
            while True:
                ...
                for _ in range(self.batch_size):
                    ...
                    for item in p_list:
                        p_array.append(self.generateHeatmap(item[0] * (400 / 46), item[1] * (600 / 46), variance=1.0))
                ...
                yield np.array(x_train), (y_train, y_train, y_train, y_train)
        if mode == 'validation':
            ...
            while True:
                ...
                yield np.array(x_eval), (y_eval, y_eval, y_eval, y_eval)
