# -*- coding: utf-8 -*-
# @File : VocAnnotationToTxT.py
# @Author: riky
# @Time : 2020/10/16 10:48
# @Software: PyCharm
# @Brief: voc转换为txt读取的yolo格式
...
class AnnotationToTxt():
    ...
    def ToTxt(self,
              ...
              WriteImgfilepath = "C:/Users/xxxxx/Desktop/Yolov2/insects/val/images/",  # 必须是绝对路径
...
if __name__ == '__main__':
   ...
   WriteTxt.ToTxt(xmlfilepath='../insects/train/annotations/xmls/',
                  WriteImgfilepath="C:/Users/xxxxx/Desktop/Yolov2/insects/train/images/",  #必须是绝对路径
